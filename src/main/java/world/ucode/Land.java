...
public class Land {
	...
	public Land(int width, MainCharacter mainCharacter) {
		...
		land1 = Resource.getResouceImage("src/main/resources/land1.png");
		land2 = Resource.getResouceImage("src/main/resources/land2.png");
		land3 = Resource.getResouceImage("src/main/resources/land3.png");
