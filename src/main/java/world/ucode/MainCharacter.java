...
public class MainCharacter {
	...
	public MainCharacter() {
		...
		normalRunAnim.addFrame(Resource.getResouceImage("src/main/resources/main-character1.png"));
		normalRunAnim.addFrame(Resource.getResouceImage("src/main/resources/main-character2.png"));
		jumping = Resource.getResouceImage("src/main/resources/main-character3.png");
		downRunAnim = new Animation(90);
		downRunAnim.addFrame(Resource.getResouceImage("src/main/resources/main-character5.png"));
		downRunAnim.addFrame(Resource.getResouceImage("src/main/resources/main-character6.png"));
		deathImage = Resource.getResouceImage("src/main/resources/main-character4.png");
		
		try {
			jumpSound =  Applet.newAudioClip(new URL("file","","src/main/resources/jump.wav"));
